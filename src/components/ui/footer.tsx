...
export const Footer = () => {
  ...
  />
            ...
            <p className="text-muted-foreground mb-6 leading-relaxed">
              Your trusted partner for premium medical equipment across Telangana. 
              Specializing in physiotherapy, rehabilitation, and hospital equipment.
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm">
                  <a href="tel:+917997069722" className="hover:text-primary transition-colors hover:underline">
                    <div className="text-foreground">+91 79970 69722</div>
                  </a>
                 <a href="tel:+917702512557" className="hover:text-primary transition-colors hover:underline">
